...
<?php
session_start();
$title = "Pendaftaran Santri Baru"; // Judulnya
...
<head>
	...
	<title><?= $title; ?> | TAHFIDZ AL-QURAN SYEIKH ABDURRAHMAN</title>
						...
						<ul class="sidebar-menu">
							...
							<li class="nav-item dropdown active">
								...
								<ul class="dropdown-menu">
									<li><a class="nav-link" href="daftarSiswa.php">Data Santri</a></li>
